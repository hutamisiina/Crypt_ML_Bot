...
# symbolごとのレバレッジ。1以下でも可能。最初にmain_pos_sizeとmax_pos_sizeが出ると思うのでそれを見ながら適当に調整。
# ただし、binance側でかならずこに記載したレバレッジ以上のレバレッジに設定しておく必要がある。
# 5ドル以下の注文は拒否されることある注意
leverage = {}
...
# 今どの通貨で資金を持っているか。先物ウォレットに入れておく必要あり。
balance_asset = 'USDT'
